package com.fahmidwipamane_202102364.tablayout;
...
public class MainActivity extends AppCompatActivity
{
    ...
    private MyFragmentPagerAdapter _myFragmentPagerAdapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _myFragmentPagerAdapater = new MyFragmentPagerAdapter (  this, getSupportFragmentManager(), tabLayout1.getTabCount());
        viewPager1.setAdapter(_myFragmentPagerAdapater);
